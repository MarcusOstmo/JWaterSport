...
namespace JWS.View
{
    public partial class JavaWaterSportGUI : Form
    {
        ...
        private void initListView()
        {
            ...
            lvwAktuellaKunder.Columns.Add("Bokad Utrustning (paket och tid)", -2, HorizontalAlignment.Left);
            lvwAktuellaKunder.Columns.Add("Bokad Dykarkurs (dykinstruktör och tid)", -2, HorizontalAlignment.Left);
        }
        ...
        private void updateListView()
        {
            ...
            for (int i = 0; i < AktuellaKunder.Count(); i++)
            {
                ...
                //columns[4] = AktuellaKunder.Get(i).get();
